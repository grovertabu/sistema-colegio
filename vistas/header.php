...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>Proyecto</b> Colegio</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Proyecto</b> Colegio</span>
    </a>
...
if ($_SESSION['acceso']==1) {
  echo '  <li class="treeview">
        ...
        <li><a href="#" target="_blanck"><i class="fa  fa-exclamation-circle"></i> <span>Acerca de</span><small class="label pull-right bg-yellow">SISTEMAS</small></a></li>   
